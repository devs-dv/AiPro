    ...
    <>
      <div className="bg-[#EFEFEF]">
        <div className="relative flex flex-col">
          ...
          <div className="md:top-10 md:rounded-2xl px-4  py-4 mx-4 my-4 border-black ">
              ...
              <div className="max-w-screen-xl mx-auto flex flex-col items-center">
                <div className="flex flex-row max-md:flex-col gap-8 md:text-left">
                  ...
                  <div>
                    ...
                    <p className="text-center">
                      Say goodbye to routine tasks. AI Lawyer automates your
                      legal research and paperwork, granting you more free time.
                    </p>
                  </div>
                </div>
                <div className="mt-8">
